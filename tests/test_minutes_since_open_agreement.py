...
research/tests/test_fomc_event_day_boost.py::test_the_vectorized_flag_cache_agrees_with_the_scalar_helper,
...
from engine.data.intraday_profile import SESSION_MINUTES, minutes_since_open
