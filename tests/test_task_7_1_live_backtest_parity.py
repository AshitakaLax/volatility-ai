...
from engine.trading import decision_cycle as decision_cycle_module
...
def test_both_paths_route_through_the_shared_decision_cycle_module():
    ...
    from engine.execution import live_execution
    from research.optimization import optimization_controller
