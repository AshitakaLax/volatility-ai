"""
The DuckDB implementation of research/optimization/result_sink.SweepResultSink.

STRUCTURAL, NOT NOMINAL: this class does not import or subclass the
Protocol it satisfies. That is what keeps research/optimization free of any
...
from engine.warehouse.connection import EXECUTIONS_DIR, lake_path
from engine.warehouse.hashing import EXECUTION_FLAG_FIELDS, parameter_hash
...
# research/run_hf_sweep.py uses for its "top distinct combinations"
