...
# NEXT bar, which is lookahead -- the same class of bug research/ml/'s
...
# that research/analysis/cost_models.py has no way to check against
...
# engine/data/external_index_series.py's ExternalIndexSeries.scalar()
...
# what research/ml/'s causal-transform rule exists to stop. external_series
