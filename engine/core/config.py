...
#
# This module is the bottom of the dependency stack -- engine/core is what
# every other package imports. It used to import engine.execution.cost_models
# and engine.trading.risk_manager at module scope, which made `core` depend
...
if TYPE_CHECKING:
    from engine.execution.cost_models import TransactionCostModel
