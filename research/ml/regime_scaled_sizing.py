...
Everything in research/ml/ before it was explicitly forbidden from doing so.
research/ml/reachability_sizing.py's own docstring is emphatic: "This
...
and engine/trading/decision_cycle.collect_liquidations already gates
...
research/optimization/trailing_target.TrailingTargetPolicy -- battle-tested
...
from research.ml.qlib_regime import NO_READING, RegimeInferenceSource, RegimeReading
...
class MLRegimeScaledSizing(_BaselineScaledStrategy):
    ...
    def __init__(
        ...
        *,
        ...
        trail_pct -- the exit side. None (the default) leaves every
            ...
            research/optimization/trailing_target.TrailingTargetPolicy. See
    ...
    def record_tick(self, context: MarketContext) -> None:
        ...
        (research/optimization/intraday_validation.py) to price a resting
        ...
        engine/trading/decision_cycle.py guarantees fires exactly once per
