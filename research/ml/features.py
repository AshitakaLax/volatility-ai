...
research/ml/sources.py. This module must not undo it, which is why nothing
...
def transformed_sources(
    ...
    *,
    ...
    over the result; research/ml/live_features.py calls it and does
    ...
    directory is the whole point of research/ml/sources.py's registry.
    """
