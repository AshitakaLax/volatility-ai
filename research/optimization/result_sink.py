...
The obvious implementation is DuckDB (engine/warehouse/), but
...
start -- and research/optimization is imported by the live path. Importing
...
So this module is stdlib-only and defines the shape; engine/warehouse
...
class SweepResultSink(Protocol):
    ...
    Implemented by engine.warehouse.duckdb_sink.DuckDBResultSink. Kept
