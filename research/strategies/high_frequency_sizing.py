...
without needing to know why it is there, using data already in hand.
  ...
  a key -- research/ml/sources.py now pulls 51 FRED series (DGS10 reaches
...
from engine.data.intraday_profile import relative_range
from engine.data.synthetic_bars import is_synthetic_bar
...
from research.strategies.sizing_indicators import (
    RollingMax,
    RollingMean,
    RollingStdev,
    bars_from_days,
